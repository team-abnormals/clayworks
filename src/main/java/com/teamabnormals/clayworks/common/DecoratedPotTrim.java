...
public record DecoratedPotTrim(Holder<TrimMaterial> material, Holder<DecoratedPotTrimPattern> pattern, boolean showInTooltip) implements TooltipProvider {
	...
	public static final String DECORATIONS_TITLE = Util.makeDescriptionId("item", Clayworks.location("decorated_pot.decorations"));
	public static final Component DECORATIONS_COMPONENT = Component.translatable(DECORATIONS_TITLE).withStyle(ChatFormatting.GRAY);
