...
public class KilnMenu extends AbstractFurnaceMenu {
	...
	public KilnMenu(int windowId, Inventory playerInventory) {
		super(ClayworksMenuTypes.KILN.get(), ClayworksRecipeTypes.BAKING.get(), RecipeBookType.valueOf("CLAYWORKS_BAKING"), windowId, playerInventory);
	}

	public KilnMenu(int windowId, Inventory playerInventory, Container kilnInventory, ContainerData furnaceData) {
		super(ClayworksMenuTypes.KILN.get(), ClayworksRecipeTypes.BAKING.get(), RecipeBookType.valueOf("CLAYWORKS_BAKING"), windowId, playerInventory, kilnInventory, furnaceData);
	}
}